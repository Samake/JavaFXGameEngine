...
public class Rock02 extends Object {

	public Rock02(Level level, Vector2D position) {
		super(level, ENTITYTYPE.OBJECT, "environment/rock2_dark.png", null, position, 0, 0.5, 0, false);
